  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(child: Consumer<KonsultasiViewModel>(
                ...
                builder: (context, model, child) {
                  return Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      textFieldConsultation("Masukkan Tinggi Badan",
                          model.heightController, "cm"),
                      const SizedBox(height: 24),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 24),
                          tagText("kali per hari"),
                        ],
                      ),
                      const SizedBox(height: 24),
                      titleConsultation(
                          "Seberapa sering Anda mengonsumsi cemilan?"),
                      const SizedBox(height: 12),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                      ...
                      const SizedBox(height: 24),
                      titleConsultation(
                          "Seberapa sering Anda minum air putih ?"),
                      const SizedBox(height: 12),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
