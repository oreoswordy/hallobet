class Obesity {
  ...
  factory Obesity.fromList(List<dynamic> data) {
    return Obesity(
      ...
      age: double.tryParse(data[1].toString()) ?? 0,
      ...
      ncp: double.tryParse(data[7].toString()) ?? 0,
      caec: data[8] as String,
      smoke: data[9] as String,
      ch2o: double.tryParse(data[10].toString()) ?? 0,
      scc: data[11] as String,
      faf: double.tryParse(data[12].toString()) ?? 0,
      tue: double.tryParse(data[13].toString()) ?? 0,
